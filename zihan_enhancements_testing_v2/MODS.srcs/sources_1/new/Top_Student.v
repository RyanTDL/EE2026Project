...
//    wire [7:0] gravity_ext;
    ...
    Control_inputs ctl (.clk(clk2k), .player(player), .btnC_p1(btnC), .btnC_p2(btnC_p2), 
        .btnU_p1(btnU), .btnU_p2(btnU_p2), .btnD_p1(btnD), .btnD_p2(btnD_p2), 
        .btnR_p1(btnR), .btnR_p2(btnR_p2), .btnL_p1(btnL), .btnL_p2(btnL_p2),
        .master_btnR(btnR_master), .master_btnL(btnL_master),
